...
module.exports = (format, date, timezone) => {
    ...
    switch (format) {
        ...
        case "MMM":
            {
                format = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][aNewDate.getMonth()];
            }
            break;
        case "MMMM":
            {
        ...
        case "Do":
            {
                ...
                if (month.toString().endsWith("1") && !month.toString().endsWith("11")) {
                    format = month.toString() + "st";
                } else if (month.toString().endsWith("2") && !month.toString().endsWith("12")) {
                    format = month.toString() + "nd";
                } else if (month.toString().endsWith("3") && !month.toString().endsWith("13")) {
        ...
        case "ddd":
            {
                format = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][aNewDate.getDay()];
            }
            break;
        case "dddd":
            {
                format = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][aNewDate.getDay()];
            }
            break;
        // Day of Year
        case "DDD":
            {
                ...
                const firstDate = new Date(new Date(Date.UTC(nowDate.getFullYear(), 0, 0)).toLocaleString("en-US", { timeZone: timezone }));

                const difference = nowDate - firstDate - (firstDate.getTimezoneOffset() - nowDate.getTimezoneOffset()) * 60 * 1000;
        ...
        case "GG":
            {
                format = new Date(aNewDate.toISOString()).getFullYear().toString().split("").splice(2).join("");
            }
            break;
        case "GGGG":
            {
        ...
        case "L":
            {
                format = aNewDate.toLocaleString("en-US", { timeZone: timezone }).split(", ")[0];
            }
            break;
        case "LL":
            {
                ...
                format = `${
                    ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][clonedDate.getMonth()]
        ...
        case "LLL":
            {
                ...
                format = `${
                    ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][clonedDate.getMonth()]
                } ${clonedDate.getDate()} ${clonedDate.getFullYear()} ${clonedDate.getHours() > 12 ? clonedDate.getHours() - 12 : clonedDate.getHours()}:${
                    clonedDate.getMinutes().toString().length === 2 ? clonedDate.getMinutes() : "0" + clonedDate.getMinutes().toString()
        ...
        case "LLLL":
            {
                const clonedDate = aNewDate;
                format = `${["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][clonedDate.getDay()]}, ${
                    ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][clonedDate.getMonth()]
                } ${clonedDate.getDate()} ${clonedDate.getFullYear()} ${clonedDate.getHours() > 12 ? clonedDate.getHours() - 12 : clonedDate.getHours()}:${
                    clonedDate.getMinutes().toString().length === 2 ? clonedDate.getMinutes() : "0" + clonedDate.getMinutes().toString()
                } ${clonedDate.getHours() > 12 ? "PM" : "AM"}`;
        ...
        case "LT":
            {
                ...
                format = `${isPM ? clonedDate.getHours() - 12 : clonedDate.getHours()}:${
                    clonedDate.getMinutes().toString().length === 2 ? clonedDate.getMinutes() : "0" + clonedDate.getMinutes().toString()
                } ${isPM ? "PM" : "AM"}`;
            }
            break;
        case "LTS":
            {
                ...
                format = `${isPM ? clonedDate.getHours() - 12 : clonedDate.getHours()}:${
                    clonedDate.getMinutes().toString().length === 2 ? clonedDate.getMinutes() : "0" + clonedDate.getMinutes().toString()
                }:${clonedDate.getSeconds().toString().length === 2 ? clonedDate.getSeconds() : "0" + clonedDate.getSeconds().toString()} ${isPM ? "PM" : "AM"}`;
            }
            break;
        ...
        case "h":
            {
                ...
                format = newDate.getHours() > 12 ? newDate.getHours() - 12 : newDate.getHours();
            }
            break;
        case "hh":
            {
