...
const Perms = {
    ...
    useprivatethreads: 'CREATE_PRIVATE_THREADS',
...
const FormatOptions = (date, timeZone) => {
    ...
    return {
        ...
        MM: (date.getMonth() + 1).toString().length === 1 ? 0 + (date.getMonth() + 1).toString() : (date.getMonth() + 1).toString(),
        ...
        DD: date.getDate().toString().length === 1 ? (0 + date.getDate().toString()) : date.getDate().toString(),
