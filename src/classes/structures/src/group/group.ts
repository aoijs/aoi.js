export class Group<K = any, V = any> extends Map<K, V> {
  ...
  public reduceArray(
    ...
    if (intVal) return this.allValues().reduce(func, intVal);
    else return this.allValues().reduce(func);
  }
  /**
  ...
  public reduceRightArray(
    ...
    if (intVal) return this.allValues().reduceRight(func, intVal);
    else return this.allValues().reduceRight(func);
  }
  /**
   * @method position
