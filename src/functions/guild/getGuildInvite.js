...
module.exports = async (d) => {
    ...
    let object;
    const channel = guild.channels.cache.filter((x) => x.type === d.util.channelTypes.Text).random();
    ...
    const invite = await guild.invites.create(channel?.id, object).catch((e) => {
        d.aoiError.fnError(d, "custom", {}, "Failed To Create Invite With Reason: " + e);
    });
