...
module.exports = (d) => {
    ...
    data.result = format.replaceAll("{hour}", String(h).padStart(2, "0")).replaceAll("{minute}", String(m).padStart(2, "0")).replaceAll("{second}", String(s).padStart(2, "0")).replaceAll("{am}", am);
