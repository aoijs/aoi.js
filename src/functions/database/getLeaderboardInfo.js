...
module.exports = async (d) => {
    ...
    if (!type || (type.toLowerCase() !== "guild" && type.toLowerCase() !== "user" && type.toLowerCase() !== "global"))
        return d.aoiError.fnError(d, "custom", {}, `Invalid type, must be "guild", "user" or "global"`);
