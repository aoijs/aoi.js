module.exports = async d => {
    ...
    if (!variable.checkType(value.addBrackets())) return d.aoiError.fnError(d, 'custom', {inside: data.inside}, `Variable "${varname.addBrackets()}" Needs Value Of Type "${variable.type}". Provided Wrong Type In`);
