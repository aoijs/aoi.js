module.exports = async d => {
    ...
    let [varname, value, userId = d.author?.id, Id = d.guild?.id || 'dm', table = d.client.db.tables[0]] = data.inside.splits;
    ...
    if (!variable.checkType(value.addBrackets()))
    ...
    try {
        await d.client.db.set(table, varname.addBrackets(), `${userId}_${Id}`, value);
    } catch (e) {
