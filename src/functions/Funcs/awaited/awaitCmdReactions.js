...
module.exports = async d =>
{
    ...
    filter = ( r, u ) => ( filter === "everyone" ? u.id !== d.client.user.id : u.id === filter ) && ( reactions.includes( r.emoji.toString() ) || reactions.includes( r.emoji.name ) || reactions.includes( r.emoji.id ) );
    ...
    } ).catch( err =>
    {
        if ( errorMsg !== "" )
        {
            d.aoiError.makeMessageError( d.client, d.channel, errorMsg, errorMsg.options );
        }
