module.exports = async d => {
    ...
    const [varname, value, userId = d.author?.id, Id = d.guild?.id || 'dm', table = d.client.db.tables[0]] = data.inside.splits;
    ...
    try {
        d.client.db.set(table, varname.addBrackets(), `${userId}_${Id}`, value);
    }
    catch (e) {
