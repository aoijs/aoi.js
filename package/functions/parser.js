...
`,
  ...
  $pruneMembers: "Prune an amount of members for a certain amount of time;$pruneMembers[amount of days(optional, defaults to 7);guildID(optional);reason(optional, defaults to none);roleid1:roleid2:roleid3...]",
  ...
  $charCase: "Check the case for the text;$charCase[text]"
};
