...
class CommandManager {
    ...
    get types() {
        return [
            'default', 'awaited', 'messageDelete',
            'messageUpdate', 'messageDeleteBulk', 'guildJoin',
            'guildUpdate', 'guildLeave', 'guildUnavailable',
            'roleCreate', 'roleUpdate', 'roleDelete',
            'channelCreate', 'channelUpdate', 'channelDelete',
            'channelPinsUpdate', 'stageInstanceCreate', 'stageInstanceUpdate',
            'stageInstanceDelete', 'stickerCreate', 'stickerDelete',
            'stickerUpdate', 'threadCreate', 'threadDelete',
            'threadListSync', 'threadMemberUpdate', 'threadMembersUpdate',
            'threadUpdate', 'join', 'leave',
            'memberUpdate', 'memberAvailable', 'membersChunk',
            'emojiCreate', 'emojiUpdate', 'emojiDelete',
            'banAdd', 'banRemove', 'webhookUpdate',
            'inviteCreate', 'inviteDelete', 'voiceStateUpdate',
            'presenceUpdate', 'reactionAdd', 'reactionRemove',
            'reactionRemoveEmoji', 'reactionRemoveAll', 'typingStart',
            'loop', 'timeout', 'pulse',
            'ready', 'variableCreate', 'variableDelete',
            'variableUpdate', 'functionError', 'interaction',
            'applicationCmdCreate', 'applicationCmdUpdate', 'applicationCmdDelete',
    ...
    createCommand(d = {}) {
        ...
        if (d.type === "interaction") {
            this[d.type][d.prototype].set(this[d.type][d.prototype].size, new Command(d, this.client))
        }
        else {
