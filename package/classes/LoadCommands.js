  ...
  async update(debug=true){
      for(const dp of this.paths){
          for(const cmd of Object.keys(dp.commandsLocation)){
              if(cmd === "interaction"){
                  dp.commandsLocation.interaction.slash.sweep(x=>x.load === true)
                  dp.commandsLocation.interaction.button.sweep(x=>x.load === true)
                  dp.commandsLocation.interaction.selectMenu.sweep(x=>x.load === true)
              }
             else dp.commandsLocation[cmd].sweep(x=>x.load === true) 
