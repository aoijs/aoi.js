...
const yearStart = new Date(new Date(Date.UTC(date.getFullYear(), 0, 1)).toLocaleString("en-us", {timeZone:Timezone}))
...
module.exports = (format, date, timezone) => {
  ...
  switch (format) {
    ...
    case 'LT': {
      ...
      format = `${isPM ? clonedDate.getHours() - 12 : clonedDate.getHours()}:${clonedDate.getMinutes().toString().length === 2 ? clonedDate.getMinutes() : "0" + clonedDate.getMinutes().toString()} ${isPM ? "PM" : "AM"}`
    }
    break;
    case 'LTS': {
      const clonedDate = aNewDate;
      const isPM = clonedDate.getHours() > 12 ? true : false;
      format = `${isPM ? clonedDate.getHours() - 12 : clonedDate.getHours()}:${clonedDate.getMinutes().toString().length === 2 ? clonedDate.getMinutes() : "0" + clonedDate.getMinutes().toString()}:${clonedDate.getSeconds().toString().length === 2 ? clonedDate.getSeconds() : "0" + clonedDate.getSeconds().toString()} ${isPM ? "PM" : "AM"}`
    }
    break;
