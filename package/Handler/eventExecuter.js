...
module.exports = async (event,client,commands,...data) =>{
    let msg = {channel: undefined,author:undefined,content:"",guild: undefined,member: undefined}
    let EventData = {}
  ...
  EventData= data
     await Interpreter(client,msg,[],cmd, undefined,false,cmd.channel,{eventData: EventData})
    }
}
