module.exports = {
    "autoUpdate": "AutoUpdate the Client to latest version of Aoi.JS (true or false)",
    ...
    "shardAmount": "Amount of shards to spawn, defaults to Discord recommended amount of shards (limit 2000)",
    "suppressAll": "SuppressAll is an option to disable all Error Messages from the Client from sending",
    "errorMessage": "Customize the SuppressAll error message in a string field",
    "mobile": "Whether to connect the Bot to the gateway through mobile status (true / false)", 
