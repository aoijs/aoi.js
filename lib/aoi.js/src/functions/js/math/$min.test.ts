...
client.transpiler.addFunctions({ $min });
...
const codeToFail = '$min';
const codeToPass = '$min[200;200]';
const codeToCalc = '$min[2;200;3]';
...
void describe('$min', () => {
	...
	void it('should return 2 for 2, 200, 3', async () => {
		...
		console.log = (log: Record<string, string>) => {
			logged = client.parseData(log.content, $min.returns);
		};
