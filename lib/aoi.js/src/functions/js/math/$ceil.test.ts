...
client.transpiler.addFunctions({ $ceil });
...
const codeToFail = '$ceil';
const codeToPass = '$ceil[200]';
const codeToCalc = '$ceil[200.5]';
...
void describe('$ceil', () => {
	...
	void it('should return 201 for 200.5', async () => {
		...
		console.log = (log: Record<string, string>) => {
			logged = client.parseData(log.content, $ceil.returns);
		};
