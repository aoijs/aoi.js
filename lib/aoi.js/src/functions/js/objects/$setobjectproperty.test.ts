...
client.transpiler.addFunctions({ $setobjectproperty });
...
const codeToFail = '$setobjectproperty';
const codeToPass = '$setobjectproperty[test;test;test]';

void describe('$setobjectproperty', () => {
