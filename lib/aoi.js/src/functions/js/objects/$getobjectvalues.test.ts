...
import { $getobjectvalues } from './$getobjectvalues.js';
import type { ITranspileOptions } from '@aoi.js/typings/interface.js';
import TestCommand from '@aoi.js/testing/testCommand.js';

const client = new TestClient();
client.transpiler.addFunctions({ $getobjectvalues });
...
const codeToFail = '$getobjectvalues';
const codeToPass = '$getobjectvalues[test]';

void describe('$getobjectvalues', () => {
