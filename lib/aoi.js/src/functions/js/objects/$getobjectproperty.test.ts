...
client.transpiler.addFunctions({ $getobjectproperty });
...
const codeToFail = '$getobjectproperty';
const codeToPass = '$getobjectproperty[test;test]';

void describe('$getobjectproperty', () => {
