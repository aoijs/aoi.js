...
import { type CommandOptions, type TranspiledFuncData } from '../typings/interfaces.js';
import { type CommandTypes, type Optional } from '../typings/types.js';
import fs, { readFile } from 'fs/promises';
import { type AoiClient, Bundler } from '../index.js';
...
export class CommandManager {
	...
	addMany(commands: Array<Optional<CommandOptions, '__path__'>>) {
	...
	async load({
		...
		const Commands: Array<{ path: string; loaded: boolean; reason?: string }> =
            [];
		if (!usingAoi) {
