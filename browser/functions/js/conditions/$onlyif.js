import { Scope, TranspilerError, Transpiler, conditionLexer } from "../../..";
import funcs from "../../";
...
export const $onlyIf = {
    ...
    code: (data, scope) => {
        ...
        if ($onlyIf.brackets) {
            if (!data.total.startsWith($onlyIf.name + "[") &&
        ...
        const conditionFunctionList = getFunctionList(condition, Object.keys(funcs));
